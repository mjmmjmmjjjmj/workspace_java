...
import chapter4.IntStack5.EmptyIntStackException;
import chapter4.IntStack5.OverflowIntStackException;
...
public class 실습4_2정수스택_배열 {
	...
	public static void main(String[] args) {
		...
		IntStack6 s = new IntStack6(4); // 최대 64 개를 푸시할 수 있는 스택
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(x);
				} catch (IntStack6.OverflowIntStackException e) {
			...
			case 2: // 팝
				...
				} catch (IntStack6.EmptyIntStackException e) {
			...
			case 4: // 덤프
				try {
					...
					System.out.println("덤프할게" + e.getMessage());
					e.printStackTrace();
				}
			...
			case 5: //clear
				try {
					s.clear();
					System.out.println("스택 비워짐");
				} catch (IntStack6.EmptyIntStackException e) {
					System.out.println("비워진 스택" + e.getMessage());
					e.printStackTrace();
				}
				break;
			}
