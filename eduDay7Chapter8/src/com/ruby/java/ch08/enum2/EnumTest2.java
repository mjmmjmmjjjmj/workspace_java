...
public class EnumTest2 {
	...
	public static void main(String[] args) {
		...
		//*cannot instantiate : 객체를 만들 수 없음 : Mandarin m = new Mandarin(100); 
		//-> enum은 새로운 객체를 만드는 게 아니라 금귤 한라봉 레드향 천혜향 황금향
		//Mandarin m4[] = Mandarin.values();//Mandarin의 생성자를 호출하고 각 값을 생성자 함수에 전달한다. : 전체를 읽어오는 거였음.
		...
		System.out.println("황금향과 비교: "+ ma.compareTo(Mandarin.레드향));//ma : 황금향...이 아니라 한라봉 아닌가?
