...
public class Test01 {
	public static void main(String[] args) {
		...
		Integer i2 = 123;//정수객체인데 wrapper 클래스에 의해 boxing된 거임
		lst.add(s2);//스트링객체
		lst.add(i2);//정수 객체
		...
		String cities[] = new String[5];//배열선언[]
		...
		//*** 중요 부분은 꼭 이해하고 넘어가기
		//addAll(Collection<?extends E : ?부터 E까지 타입> c변수)
		//ArrayList <String>:generic type을 String으로 지정하는 것 list : 변수
		//showData(int타입[]data변수)
		list.addAll(list2);
		print(13, list);
