...
public class Test01_Cha09 {
	public static void main(String[] args) {
		Object obj1 = new Object();
		Object obj2 = new Object();
		Object obj3 = new Object();
		//obj1.hashCode()
		//hashcode : 식별자 identifier
		//new 메모리공간 할당
		//new Object : object에 대한 메모리를 할당하고 주소를 반환함. 
		//
		...
		obj1.toString(); //수업시간에 추가로 입력한 거
		System.out.println(obj1);//toString() 결과와 같은 이유는 자동적인 타입 캐스팅 때문임 > 정수를 hexa로 변경한 것
		//System.out.println(obj1)에서 obj 1는 String. String s = obj1
